...
namespace CarRentalSystem.Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20220916143531_Statistics")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.Statistics.CarAdView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.Statistics.Statistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRentalSystem.Infrastructure.Identity.Role", b =>
                {
            ...
            modelBuilder.Entity("CarRentalSystem.Infrastructure.Persistence.Auditable.AuditEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRentalSystem.Domain.Models.Statistics.CarAdView", b =>
                {
                    b.HasOne("CarRentalSystem.Domain.Models.CarAds.CarAd", null)
                        .WithMany()
                        .HasForeignKey("CarAdId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CarRentalSystem.Domain.Models.Statistics.Statistic", null)
                        .WithMany("CarAdViews")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CarRentalSystem.Infrastructure.Identity.Role", null)
                        .WithMany()
