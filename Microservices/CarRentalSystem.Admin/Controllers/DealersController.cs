namespace CarRentalSystem.Admin.Controllers
{
    ...
    public class DealersController : AdministrationController
    {
        ...
        public async Task<IActionResult> Index() => View(await this.dealers.All());

        [HttpGet]
        public async Task<IActionResult> Edit(int id)
        {
            DealerDetailsOutputModel dealer = await this.dealers.Details(id);

            DealerFormModel dealerForm = this.mapper.Map<DealerFormModel>(dealer);
