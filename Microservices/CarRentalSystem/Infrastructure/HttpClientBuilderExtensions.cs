        ...
        public static void WithConfiguration(
            ...
            => httpClientBuilder
                .ConfigureHttpClient((serviceProvider, client) =>
                {
                    ...
                    IServiceProvider requestServices = serviceProvider
                        .GetService<IHttpContextAccessor>()
                        ?.HttpContext
                        .RequestServices;

                    string currentToken = requestServices
                    ...
                    AuthenticationHeaderValue authorizationHeader = new AuthenticationHeaderValue(AuthorizationHeaderValuePrefix, currentToken);
